...
| Abnormal-gait detection on CARE-PD | **REAL, MEASURED — AUC ≈ 0.86** | The diagnosis-relevant framing (detect UPDRS-gait > 0): pooled **AUC 0.86**, 0.87 best cohort, ~79% sens/spec, subject-level CV, permutation AUC 0.51. A gait-screening number, not standalone PD diagnosis. See [CAREPD_RESULTS.md](CAREPD_RESULTS.md). |
