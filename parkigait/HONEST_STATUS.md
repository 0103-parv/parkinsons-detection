...
| ">90% Pearson correlation with UPDRS" | **REAL (synthetic data ONLY)** | `eval.py` reports r ≈ 0.99 between predicted and *synthetic* ground-truth severity, and control-vs-PD AUC ≈ 0.86–0.94 on a deliberately hard, overlapping synthetic cohort. This is a method demo, NOT a clinical correlation — there is no real UPDRS correlation because CARE-PD was never trained on here. |
